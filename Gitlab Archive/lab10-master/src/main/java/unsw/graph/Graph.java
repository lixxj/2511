...
public class Graph<N extends Comparable<N>> implements Iterable<N>, Iterator<N> {
    ...
    public void addNode(N node) {
        ...
        if (iterator == null) iterator = new BreadthFirstGraphIterator<>(this, node);
    ...
    public Iterator<N> breadthFirstIterator(N n) {
        return new BreadthFirstGraphIterator<N>(this, n);
    }

    public Iterator<N> depthFirstIterator(N n) {
        return new DepthFirstGraphIterator<N>(this, n);
    }
}